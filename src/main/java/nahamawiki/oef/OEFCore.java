...
import nahamawiki.oef.core.OEFTileEntityCore;
...
import nahamawiki.oef.render.RendererEEConductor;
...
public class OEFCore {
	...
	public void init(FMLInitializationEvent event) {
		...
		OEFTileEntityCore.register();
		if (FMLCommonHandler.instance().getSide() == Side.CLIENT) {
			ClientRegistry.bindTileEntitySpecialRenderer(TileEntityEEConductor.class, new RendererEEConductor());
