	...
	public void onUpdate()
    {
        ...
        if (this.isEntityAlive())
        {
            ...
            if (this.timeSinceIgnited >= 30)
            {
                ...
                if(!worldObj.isRemote)this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, r, false);
                this.setDead();
                ...
                for (int z = -1 * searchRange; z < 1 * searchRange; ++z)
                {
                	blockZ = z + oz;
                    		...
                    		if (par1World.getTileEntity(blockX, blockY, blockZ) != null && par1World.getTileEntity(blockX, blockY, blockZ) instanceof TileEntityEEMachineBase)
                    		{
                    			...
                    			if(!worldObj.isRemote)par1World.createExplosion(this, blockX, blockY, blockZ, height, true);
                    		}
