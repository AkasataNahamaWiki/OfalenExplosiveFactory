...
public class OEFItemCore {
	...
	public static final ToolMaterial TMEESword = EnumHelper.addToolMaterial("TMEESword", 0, 250, 0, 21F, 0);
	public static ToolMaterial TMEE = EnumHelper.addToolMaterial("TMEEPerfect", 5, 500, OfalenModConfigCore.efficiencyPerfectTool, 0, 100);
	public static ArmorMaterial AMEE = EnumHelper.addArmorMaterial("AMEE", 30, new int[] { 0, 0, 0, 0 }, 100);
	...
	public static ItemStack PlateSet;
	...
	public static void registerItems() {
		...
		PlateSet = new ItemStack(materials, 1, 10);
